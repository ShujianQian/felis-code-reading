...
for num_warehouses in "${NUM_WAREHOUSES[@]}"; do
  for repeat in {1..1}; do
    ...
    ERR_FILENAME="caracal_tpcc_${num_warehouses}_${repeat}.err"
    ...
    $DB_EXECUTABLE -c 127.0.0.1:8989 -n host1 -w tpcc -XMaxNodeLimit1 -Xcpu32 -Xmem30G -XEpochSize100000 -XNrEpoch20 -XVHandleBatchAppend "-XTpccWarehouses${num_warehouses}" "-XOnDemandSplitting${split_threshold}" >$OUTPUT_DIR/$OUTPUT_FILENAME 2> $OUTPUT_DIR/$ERR_FILENAME &
