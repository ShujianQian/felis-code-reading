...
num_warehouses = ["1", "64"]
epoch_sizes = [5000, 6000, 7000, 8000, 9000, 10000, 12000, 14000, 16000, 18000, 20000, 25000]
repeat = 5
    ...
    for num_w in num_warehouses:
        ...
        for epoch_size in epoch_sizes:
            ...
            for i in range(1, repeat + 1):
                filename = f"caracal_tpcc_{num_w}_{epoch_size}_{i}.txt"
        ...
        csv_filename = f"caracal_tpcc_{num_w}_latency.csv"
